...
const mockData = [
  ...
  },
  {
    id: "0003",
    image: Image3,
    title: "Sesame crusted beef Burger",
  ...
  },
  {
    id: "0004",
    image: Image4,
    title: "Sweet and Sour Tofu Burger",
    paragraph: "House patty, cheddar cheese, bacon, onion, mustard. tofu",
    rating: 3.5,
    price: 99.25,
  },
  {
        ...
        <Container>
          <Row>
            <Col lg={{ span: 8, offset: 2 }} className="text-center mb-5">
              <h2>DINE'N DELIGHT</h2>
              <p className="para">
              Step into Dine'n Delight, where burgers meet delight in every delicious bite.
               We're thrilled to have you join us in this culinary adventure,
                where our passion for burgers shines through in every dish. 
              </p>
            </Col>
          </Row>
          <Row>
