      ...
      <Container>
        <Row>
          <Col lg={{ span: 8, offset: 2 }} className="text-center mb-5">
            ...
            <p className="para">
            Dive into a world of mouthwatering madness with our extraordinary burger menu. From towering stacks of sizzling beef to adventurous veggie creations, our crazy burgers redefine culinary creativity.
            </p>
          </Col>
        </Row>
        <Row>
