...
import StoreGoogle from "../../images/googleplay.png";
import DownloadImage from "../../images/e-shop.png";
import Brand1 from "../../images/brand-11.png";
import Brand2 from "../../images/brand-12.png";
import Brand3 from "../../images/brand-13.png";
import Brand4 from "../../images/brand-14.png";
import Brand5 from "../../images/brand-15.png";
import Brand6 from "../../images/brand-16.png";
import Brand7 from "../../images/brand-17.png";
import Brand8 from "../../images/brand-18.png";
        ...
        <Container>
          <Row className="align-items-center">
            <Col lg={6} className="text-center text-lg-start mb-5 mb-lg-0">
              ...
              <h2>save up to 20%</h2>
              <p>
                Get the Mobile App of Tasty Burger on App store and Google Play and win exciting offers everyday
              </p>
              <Link to="/">
                <img
                  src={StoreIOS}
